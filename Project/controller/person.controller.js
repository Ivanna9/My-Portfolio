  ...
  class PersonController {
    ...
    async createPerson (req,res) {
        ...
        const newPerson = await query (
          'INSERT INTO person (person_name,password,person_role,department,date_registered,active,email, phone_number) values ($1,$2,$3,$4,$5,$6,$7,$8) RETURNING *',
          [person_name,password,person_role,department,date_registered,active,email,phone_number]
      );
    ...
    async updatePerson(req, res) {
      ...
      const person = await query(
          ...
          [person_name, password, person_role, department, date_registered, active, email, phone_number, person_id ,location_id]
      );
      res.json(person.rows[0]);
  }
